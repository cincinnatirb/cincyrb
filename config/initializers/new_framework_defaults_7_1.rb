...
# Enable the new cache format version for Rails 7.1
Rails.application.config.active_support.cache_format_version = 7.1

# Enable raising on assignment to attr_readonly fields
Rails.application.config.active_record.raise_on_assign_to_attr_readonly = true

# Enable the Active Record strict_loading_by_default setting
Rails.application.config.active_record.strict_loading_by_default = false
